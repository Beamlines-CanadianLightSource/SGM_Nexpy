...
#### Alternatively you can use the graphical install within NeXpy by going to `File->Install Plugin` in nexpy and selecting the extracted folder.  Select the "Install Locally" if you do not want to, (or don't have permissions to) install the plugin system wide, and press OK. 
